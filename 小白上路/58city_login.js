...
function get_i(password) {
    var i = 1411093327735 - (new Date).getTime(),
    o = (new Date).getTime() + i;   
    return o + encodeURIComponent(password)     // 最终的i其实是1411093327735加上密码生成
}
...
function get_pwd(password) {
    ...
    return encryptString(i, t, s);

}

// console.log(get_pwd("wtjgbdsjh"));